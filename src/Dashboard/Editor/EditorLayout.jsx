...
import { FiUpload, FiList, FiLogOut, FiMenu, FiChevronRight, FiBell, FiCheckSquare, FiUser } from 'react-icons/fi';
      ...
      <div className="flex-1 flex flex-col h-screen overflow-y-auto">
        ...
        <header className="flex items-center justify-between px-4 lg:px-8 py-4 border-b border-white/5 bg-[#0e0e0e] z-50 sticky top-0">
          <div className="flex items-center gap-4">
            ...
            <p className="text-white font-semibold text-sm lg:hidden">Editor Panel</p>
            <div className="hidden lg:block">
              <h1 className="text-white font-semibold text-lg">Welcome, {user?.name || 'Editor'} 👋</h1>
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="relative">
              ...
              >
                ...
                <div className="w-9 h-9 rounded-full bg-gradient-to-br from-blue-500 to-indigo-400 flex items-center justify-center text-white font-bold text-sm flex-shrink-0 overflow-hidden">
                  {user?.profileImage ? (
