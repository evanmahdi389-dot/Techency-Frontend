...
import { FiCheck, FiX, FiSearch, FiPlay, FiCopy } from 'react-icons/fi';
...
export default function BrowseVideos() {
  ...
  const fetchVideos = async () => {
    ...
    try {
      ...
      // Note: Backend automatically scopes to 'approved' videos for sales users
  ...
  useEffect(() => {
    setCurrentPage(1);
  }, [search, selectedMainCat, selectedSubCat]);
